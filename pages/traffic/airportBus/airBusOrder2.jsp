...
<head lang="en">
    ...
    <style>
    	...
    	.ui-page-theme-a .ui-btn, html .ui-bar-a .ui-btn,
    	 html .ui-body-a .ui-btn, html body .ui-group-theme-a 
    	 .ui-btn, html head+body .ui-btn.ui-btn-a, 
...
<div class="box airportOrder">
   ...
   <!--  <div class="topColor">
    ...
    <div class="mainBox bottom0">
    	 <input type="hidden" id="sRouId" name="sRouId" value="${sRouId }" form="busForm" />
	    <input type="hidden" id="rouId" name="rouId" value="${rouId }" form="busForm" />	 
    	<div class="orderMessage">
    		<ul>
	    		...
	    		<li>
	    			...
	    			<img class="rposition img" src="${ctx }/resource/image/main/time.png"></img>
	    			<span>出行时间</span>
	    			<select id="startTimeTodayStr"  name="startTimeTodayStr" form="busForm" >
	    				<c:choose>
	    		...
	    		<%-- <li class="input">
	    			<img class="rposition img" src="${ctx }/resource/image/main/time.png"></img>
	    			<span>出行时间</span>
    				<input placeholder="请选择出行时间" type="date" id="startTimeTodayStr"  name="startTimeTodayStr" form="busForm" />
	    		</li> --%>
	    		<li class="input">
	    		...
	    		<li class="input">
	    			...
	    			<span>身份证号</span>
	    			<input type="text" id="idCardNum" name="idCardNum" placeholder="请输入乘车人真实信息" style="text-align: right" form="busForm" ></input>
	    		</li>
	    		<%-- <li>
	    		...
	    		<li class="input">
	    			<img class="seperate img" src="${ctx }/resource/image/main/order.png">
	    			<span>购票总数</span>
	    			<span class="orderNum" id="orderNum"><i class="fa fa-minus"></i><input type="text" id="bookSeat" name="bookSeat" form="busForm" style="" data-role="none" readonly="" value="1"><small>张</small><i class="fa fa-plus"></i></span>
	    		...
	    		<li>
	    			...
	    			<span>票价合计</span>
	    			<span class="red price"  id="cityprice" >${price }元</span>
	    			<input type="hidden" value="${price }">	    			
	    			<input type="hidden" name="price" id="price" value="${price }" form="busForm" />
	...
	var today='${dayList[0]}';
    	...
    	/* $(document).ready(function(){
    		//解决 时间placeholder 不显示的问题
    		 var o = document.getElementById("startTimeTodayStr");
        	o.onfocus = function(){
    	...
    	function submitOrder(){
    		...
    		//window.location.href="${ctx}/airportbus/submitBusOrder.do?startTimeTodayStr="+startTimeTodayStr+"&bookType="+bookType+"&totalCost="+totalCost+"&mobile="+mobile+"&passenger="+passenger+"&sitnum="+sitnum;
