    	...
    	<div class="orderMessage">
    		<ul>
	    		...
	    		<li>
	    			...
	    			<span>订单号</span>
	    			<span style="font-size:12px;    white-space: nowrap;text-overflow: ellipsis; -o-text-overflow: ellipsis; overflow: hidden;">${bookNo }</span>
	    		</li>
	    		<li>
		 ...
		 <div class="ticktState in">
    	  ...
    	  <a class="btn judge" onclick="goBack()">已生成订单!</a>
