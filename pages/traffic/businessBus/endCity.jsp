    ...
    <div class="mainBox bottom0">
      ...
      <span class="taged tip bgred"  id="r-result" >请输入或者在地图上选择下车地点！！<input type="text" id="suggestId" size="20" value="请输入地点:" style="width:auto;" />
       ...
       <a class="btn blue" onclick="submitOrder()" data-ajax="false">提交订单</a>
    	...
    	<input type="hidden" name="sRouId" value="${sRouId }" >
    	<input type="hidden" name="rouId" value="${rouId }" >
    	<input type="hidden" name="startSite" value="${startSite }" >
       <input type="hidden" name="endSite" id="endSite" value="${endSite }" >
		...
		function translatePoint(pt){
			...
			geoc.getLocation(pt, function(rs){
	            var addComp = rs.addressComponents;
		         ...
		         $("#endSite").val(result);
				var label = new BMap.Label("下车位置:"+result,{offset:new BMap.Size(20,-10)});
