...
<div class="box" class="">
    ...
    <div class="mainBox bottom0">
       ...
       <%--  <div class="putBox">
       	...
       	<h4>城际专线:请选择出发城市</h4>
       	<div class="tagedBox">
       		<span class="taged" onclick="getCityCode(this)">沈阳</span>
       		<span class="taged" onclick="getCityCode(this)">抚顺</span>
       		<span class="taged" onclick="chooseAirPort()">桃源机场</span>  
	    ...
	    <a class="btn blue"  onclick="viewLine();">预约线路</a>
   ...
   <%--  <div class="footer">
    	...
    	$.ajax({
    		...
    		success:function(data){    	
    			for(var i=0;i<data.length;i++){
    				...
    				str+='<span class="taged" onclick="getSite(this)">'+data[i].staName+'</span>';
    			} 
    			$addSite.html(str);
    		},
    		error:function(){
    ...
    function viewLine(){    	
    	alert(city);
    	alert(site);
    	var url="${ctx}/busniessbus/in/toChooseStart.do?startCity="+city+"&startSite="+site;
    	window.location.href=url;
    }
