    ...
    <div class="mainBox bottom0">
      ...
      <span class="taged tip bgred"  id="r-result" >请输入或者在地图上选择下车地点！！<input type="text" id="suggestId" size="20" value="请输入地点:" style="width:auto;" />
       ...
       <a class="btn blue" onclick="submitOrder()" data-ajax="false">提交订单</a>
    	...
    	<form id="businessCarForm" action="${ctx }/busniessbus/submitorder.do" method="post">
       <input type="hidden" name="startSite" value="${cityCode }" >
       ...
       <input type="hidden" name="bookType" value="${tgCarId }" >
