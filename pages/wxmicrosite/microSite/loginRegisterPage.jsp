...
<div id="frame">
	...
	<div id="con">
		...
		<div class="userline_info" id="username_info"></div>
		<div class="userline"><div class="userline_1 c2">确认密码&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="userline_2"><input name="userPassword" id="userPassword" type="password" placeholder="请输入确认密码"/></div><div class="userline_3"></div></div>
		<div class="userline_info" id="username_info"></div>
		<div class="userline"><div class="userline_1 c3">OPENID&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="userline_2"><input name="openID" id="openID" type="text" placeholder="请输入OPENID"/></div><div class="userline_3"></div></div>
		<div class="userline_info" id="username_info"></div>
		<div class="userline"><div class="userline_1 c4">手机号&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="userline_2"><input name="phoneNumber" id="phoneNumber" type="text" placeholder="请输入手机号"/></div><div class="userline_3"></div></div>
		<div class="userline_info" id="pass_info"></div>
		<div class="login_button" ><input type="submit" value="注册" style="width:100%;height:100%;background:none;border:none;color:#ffffff;font-size:16px;"></div>
		<div class="reg_div">
			<div class="reg_div_1"><!--a href="./getpwd.jsp" target="_self" style="color:#7A7A7A;">忘记密码？</a--></div>
			<div class="reg_div_2"><a href="<%=basePath%>toLogin" >立即登陆</a></div>
		</div>
		</form>
		</div>
	</div>
