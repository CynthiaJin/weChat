				    ...
				    series : [				        
				        {
						    ...
						    data:[{value:"${pms01List[0].Y}", name:'${pms01List[0].Z}'}]
				        }
				    ]
				};
   	         var option1 = {
 				    ...
 				    series : [				        
 				        {
 						    ...
 						    data:[{value:"${pms02List[0].Y}", name:'${pms02List[0].Z}'}]
 				        }
 				    ]
 				};
   	      var option2 = {
				    ...
				    series : [				        
				        {
						    ...
						    data:[{value:"${pms04List[0].Y}", name:'${pms04List[0].Z}'}]
				        }
				    ]
				};
   	         	//---加载option对象-----
	...
	<div id="con">
		<div class="detail-list;" style="background-color:#FFF;width:95%;margin-left:2.5%;margin-top:10px;">		
			<div class="tr-div" style="margin:0 auto;width:100%;height:250px;max-width:500px;height:auto;margin-top:0px;overflow:hidden;position:relative;cursor:pointer;text-align:center;">
				...
				<div id="pms01" style="float:left;height:230px;width:49.4%;border:1px solid #ccc;"></div>
				<div id="pms02" style="float:left;height:230px;width:49.4%;border:1px solid #ccc;"></div>
			</div>
