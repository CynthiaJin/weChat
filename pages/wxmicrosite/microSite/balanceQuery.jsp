...
<style type="text/css">
	...
	.perlist{border:1px;width:100%;height:40px;float:left; margin-left:2.5%; width:95%; position: relative; z-index:9; background:#FFF; padding-top:0px;}
 </style>
</head>
<body>
<div id="frame">
	...
	<div id="con">
		<div class="tm_div" style="height:80px !important;background-color:#F5F5F5;width:95%;margin-left:2.5%;">
				...
				<div style="position:absolute;left:27%;top:25%;width:60%;height:45px;line-height:45px;background-color:#EEEE11;align:center;"><h4>用户登录所用帐号</h4></div>
		</div>
