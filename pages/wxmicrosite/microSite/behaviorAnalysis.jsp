...
<div id="frame">
	<div id="top">
			...
			<a id="title" >行为分析</a>
			<span id="list">	
				<a href="javascript:window.history.back();"><img src="<%=path%>/resouces/image/goback.png" ></a>
		   		<a href="<%=basePath%>toLogin"><img src="<%=path%>/resouces/image/userlogin.png" ></a> 
			</span>
	</div>
	<div id="con">
		<div class="tm_div" style="height:70px !important;background-color:#F5F5F5;width:95%;margin-left:2.5%;">
		...
		<div class="detail-list;" style="background-color:#FFF;width:95%;margin-left:2.5%;">
			<div class="tr-div" style="margin:0 auto;width:93%;height:250px;max-width:500px;height:auto;margin-top:0px;overflow:hidden;position:relative;cursor:pointer;text-align:center;">
				<div style="height:40px;line-height:40px;background-color:#DBEAF9;">
						<h4>用户行为分析bar</h4>
				</div>
				<div  style="heigth:190px;">
				   <a href="<%=basePath%>toEchartsbar">	<img src="<%=path%>/resouces/image/behavior/unionuser.jpg"  width="100%;" ></a>	
				</div>
			</div>
			<div class="tr-div" style="margin:0 auto;width:93%;height:250px;max-width:500px;height:auto;margin-top:0px;overflow:hidden;position:relative;cursor:pointer;text-align:center;">
				<div style="height:40px;line-height:40px;background-color:#DBEAF9;">
				...
				<div  style="heigth:190px;">
					 <a href="<%=basePath%>toEchartsline"><img src="<%=path%>/resouces/image/behavior/weixinuse.png"  width="100%;" ></a>	
				</div>
			</div>
			<div class="tr-div" style="margin:0 auto;width:93%;height:250px;max-width:500px;height:auto;margin-top:0px;overflow:hidden;position:relative;cursor:pointer;text-align:center;">
				<div style="height:40px;line-height:40px;background-color:#DBEAF9;">
				...
				<div  style="heigth:190px;">
					 <a href="<%=basePath%>toEchartspie"><img src="<%=path%>/resouces/image/behavior/weixinincre.jpg"  width="100%;" ></a>	
				</div>
			</div>		
		</div>
	</div>
